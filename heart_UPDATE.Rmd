...
## heart$target does not produce numeric vector of binary observations 
## if we are going to move forward with this code then we need to change target to binary (0/1)
```
