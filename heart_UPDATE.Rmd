...
#plot the ROC curve
testroc2 = roc(predictor = as.data.frame(rf_random$finalModel$votes)$Yes, response = rf_random$finalModel$y, levels = rev(levels(rf_random$finalModel$y)))

plot(testroc2, type = "S")
text(x = .40, y = .6,paste("AUC = ", round(testroc2$auc, 3)))
```
# More complex model
