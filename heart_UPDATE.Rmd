...
testroc4 <- roc(predictor = complex_model$pred$Yes, response = complex_model$pred$obs, levels = rev(levels(complex_model$pred$obs)),
              smoothed=FALSE, ci=FALSE, plot=TRUE, print.auc=TRUE)
...
#plot the ROC curve
testroc5 <- roc(predictor = complex_model2$pred$Yes, response = complex_model2$pred$obs, levels = rev(levels(complex_model2$pred$obs)),
              smoothed=FALSE, ci=FALSE, plot=TRUE, print.auc=TRUE)
```
